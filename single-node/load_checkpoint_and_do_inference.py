...
with tf.Session() as sess:
    ...
    prediction = np.array(sess.run([PredictionMask], feed_dict={
                          "Images:0": imgs_test[img_number:(img_number+1), :, :, :]}))

print("Dice score = {:.4}".format(dice_score(
    prediction[0, :, :, 0], msks_test[img_number, :, :, 0])))
