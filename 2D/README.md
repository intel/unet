...
3. Create a Conda environment with TensorFlow 1.12. Command: `conda create -c intel -c anaconda -n decathlon pip python=3.6 tensorflow keras tqdm h5py psutil`
